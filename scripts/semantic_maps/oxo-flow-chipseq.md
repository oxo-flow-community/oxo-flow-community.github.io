...
|---|---|
| refs | reference::bwa_index_build, reference::star_genomegenerate, reference::bowtie2_index_build, reference::chromap_index_build, reference::blacklist_regions, reference::getchromsizes, reference::gtf2bed, align::bwa_mem, align::star_align, align::bowtie2_align, align::chromap_align |
...
| qcq | qc::fastqc, qc::trimgalore, filter::preseq, filter::picard_collectmultiplemetrics, filter::phantompeakqualtools, filter::multiqc_custom_phantompeakqualtools |

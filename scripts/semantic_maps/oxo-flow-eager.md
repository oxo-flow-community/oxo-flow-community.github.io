...
| ancient | damageprofiler, qualimap, endor_spy, sexdeterrmine, mtnucratio, nuclear_contamination, print_nuclear_contamination, mapdamage_calculation, mapdamage_rescaling, pmdtools, bedtools_coverage, bam_trim, picard_addorreplacereadgroups, preseq |

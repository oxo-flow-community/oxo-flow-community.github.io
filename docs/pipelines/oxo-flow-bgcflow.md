...
![oxo-flow-bgcflow pipeline overview](../assets/dag/oxo-flow-bgcflow.svg)

<p class="ox-dag-caption">figure · oxo-flow-bgcflow — pipeline overview (nf-metro transit map)</p>

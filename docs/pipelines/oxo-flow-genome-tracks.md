...
<div class="ox-kv"><span class="k">Compute</span><span class="v"><span title="up to 4 CPUs / 4 GB per rule (opt-in igv_report: 8 GB)">up to 4 CPUs / 4 GB per rule (opt-in igv_report: 8 GB)</span></span></div>

...
![oxo-flow-unsupervised pipeline overview](../assets/dag/oxo-flow-unsupervised.svg)

<p class="ox-dag-caption">figure · oxo-flow-unsupervised — pipeline overview (nf-metro transit map)</p>

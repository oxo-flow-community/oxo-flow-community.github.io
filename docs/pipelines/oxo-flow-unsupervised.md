...
<a href="/assets/dag/oxo-flow-unsupervised.svg?v=c2737198b1" target="_blank" rel="noopener" title="Open at native resolution"><img src="/assets/dag/oxo-flow-unsupervised.svg?v=c2737198b1" alt="oxo-flow-unsupervised pipeline overview" loading="lazy"></a>

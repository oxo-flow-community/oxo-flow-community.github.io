...
![oxo-flow-varlociraptor pipeline overview](../assets/dag/oxo-flow-varlociraptor.svg)

<p class="ox-dag-caption">figure · oxo-flow-varlociraptor — pipeline overview (nf-metro transit map)</p>

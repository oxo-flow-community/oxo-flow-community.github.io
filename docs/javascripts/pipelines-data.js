...
window.OXO_PIPELINES = [
  ...
  },
  {
    ...
    "title": "Clinical WES/WGS tumor/normal variant calling + RNA fusion & mutation + tumor-only sub-workflows",
    "origin": "port",
    "rating": "live-verified",
    "engine": "snakemake",
    "source": {

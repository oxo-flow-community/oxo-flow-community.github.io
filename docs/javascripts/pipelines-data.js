...
window.OXO_PIPELINES = [
  ...
  },
  {
    ...
    "quickstart_note": "Runs the default path on the shipped fixtures \u2014 about 153 instances (198-rule DAG; 45 rules gated off). Preview with `oxo-flow dry-run main.oxoflow`.",
    "coverage": "default-path"
  },
  {

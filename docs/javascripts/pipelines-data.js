...
window.OXO_PIPELINES = [
  ...
  },
  {
    ...
    "coverage": "default single-end aligner=bwa path live-verified; 27 when-gated branch rules (paired-end, bowtie2/chromap/star aligners, reference prep, mito filter, consensus peaks/DESeq2, preseq/picard/ataqv/IGV/R QC) \u2014 per-gate live runs on bioinfo-wsx"
  },
  {
  ...
  },
  {
    ...
    "quickstart_note": "Needs reference genome and reads \u2014 see Requirements.",
    "coverage": "default-path + branch module (34 rules, gated off by default); all 14 branch smoke steps live-verified on tx-ubuntu (engine 0.14.1, eager docker 2.5.3)"
  },
  {

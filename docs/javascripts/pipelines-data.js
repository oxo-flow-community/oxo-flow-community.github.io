...
window.OXO_PIPELINES = [
  ...
  },
  {
    ...
    "title": "Clinical WES tumor/normal variant calling + RNA fusion & mutation sub-workflow",
    "origin": "port",
    "rating": "live-verified",
    "engine": "snakemake",
    "source": {
    ...
    "compute": "up to 30 threads / 10 GB per rule",
    "quickstart_note": "Needs clinical sequencing inputs \u2014 see Requirements. RNA sub-workflow: `oxo-flow run main_rna.oxoflow -t fastp_trim -t STAR_1_pass -t STAR_arriba_map -t STAR_mut_map -t arriba_fusion -t mutect2 -t lofreq -t varscan2 -t norm_filter` (fixture kit ships in test/fixtures).",
    "coverage": "default-path; rna-subworkflow (26 rules)",
    "extra_workflows": [
      {

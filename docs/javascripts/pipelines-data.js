...
window.OXO_PIPELINES = [
  ...
  },
  {
    ...
    "coverage": "all five aligner branches (cellranger/simpleaf/kallisto/star/star-dropseq) live-verified on tx-ubuntu (engine 0.15.0, apptainer) 2026-08-27"
  },
  {
    "name": "oxo-flow-mag",
  ...
  },
  {
    ...
    "installation": {
      ...
      "runtime": "Docker or Singularity for the 41 container rules; conda/mamba for the picard_markduplicates env"
    },
  ...
  },
  {
    ...
    "coverage": "default amplicon path + 31 gated branch rules (82 total): bcftools variant caller, ivar consensus, metagenomic protocol, unicycler/minia assemblers, MarkDuplicates, plasmidID, kraken2/freyja/pangolin DB downloads, additional annotation \u2014 all dry-run-verified per branch; default plan unchanged"
  },
  {
    "name": "oxo-flow-eager",
    ...
    "quickstart_note": "Needs reference genome and reads \u2014 see Requirements.",
    "coverage": "default-path + metagenomic/bam_unmapped_type/run_bam_filtering branches; all live-verified on tx-ubuntu (engine 0.15.0, eager docker 2.5.3) 2026-08-26"
  },
  {
  ...
  },
  {
    ...
    "coverage": "default-path + branch module (26 rules, gated off by default); default path + tier-1 (seqfu/mash/fastani/roary) + tier-2 (checkm/amrfinderplus) branches live-verified on bioinfo-wsx (engine 0.14.1)"
  },
  {

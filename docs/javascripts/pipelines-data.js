...
window.OXO_PIPELINES = [
  ...
  },
  {
    ...
    "coverage": "single entry (upstream Snakefile form): run_type wes/wgs/rna; paired vs unpaired WES derived per pair from the sample sheet. Live-verified on tx-ubuntu; merged-form re-verification on the PR #187 engine in progress (wes/wgs/rna queue)."
  },
  {

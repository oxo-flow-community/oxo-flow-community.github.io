...
(2026-08 campaign, 19 live-verified and counting). It is a **referenceassistant — the AI layer (the [`live-test` skill](https://github.com/oxo-flow-community/oxo-flow-community.github.io/blob/main/skills/live-test/SKILL.md))
